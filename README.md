...
Se utilizó FIGMA.COM para crear el wireframe y el mockup original, presentando al cliente
...
Se utilizó una paleta de colores de COOLORS.CO dándole al sitio cierta sobriedad, 
...
Fueron utilizadas distintas imágenes en formato .JPG | .PNG

Se aplicó SEO tanto en el index como en cada una de las páginas en forma individual.
...
ANIMATE.CSS | GOOGLE.FONTS | PLACE-HOLD.IT | KIT.FONTAWESOME | .GIF | .JPG | .PNG
